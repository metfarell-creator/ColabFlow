                      ...
                      <div key={model.id} className="border border-[#141414] p-6 space-y-4">
                        <div className="flex items-start justify-between">
                          ...
                          <button 
                            ...
                            className="text-[#141414] opacity-30 hover:opacity-100 hover:text-red-500 transition-all"
                          >
                            <Trash2 size={14} />
                          </button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {Object.entries(model.hyperparameters).map(([key, val]) => (
                            <div key={key}>
                              <p className="text-[8px] uppercase opacity-40 mb-1 font-bold">{key}</p>
                              <input 
                                value={val}
                                onChange={(e) => {
                                ...
                                className="bg-[#141414]/5 border-b border-[#141414]/20 px-2 py-1 text-[10px] w-full outline-none focus:bg-[#141414]/10 transition-colors"
                              />
                            </div>
                          ))}
                        </div>
                    ...
                    <div className="space-y-2">
                      {selectedProject.tasks.map(task => (
                        <motion.div 
                          ...
                          animate={{ opacity: 1, x: 0 }}
                          key={task.id} 
                          className="flex items-center gap-3 border border-[#141414] p-3 group"
                        >
                          <button 
                            onClick={() => {
                          ...
                          <input 
                            ...
                            className={`bg-transparent text-xs font-mono outline-none flex-1 ${task.status === 'Done' ? 'line-through opacity-40' : ''}`}
                          />
                          <div className={`text-[8px] uppercase font-bold px-1.5 py-0.5 border ${
